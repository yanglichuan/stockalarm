package com.ad.block.osaadblock.circleprogress;
            ...
            if (mTextLength != text.length()) {
                ...
                if (mShowUnit) {
                    ...
                    if (LauguageUtil.isTrkin()){
                        mOuterTextBounds = new RectF(mOuterTextBounds.left - (mUnitBounds.width() / 2f) - (gapWidthHalf),
                                mOuterTextBounds.top, mOuterTextBounds.right + (mUnitBounds.width() / 2f) + (gapWidthHalf),
        ...
        if (mShowUnit) {
            ...
            if (update) {
                ...
                if (mIsAutoTextSize) {
                    ...
                    //addylc
                    if(LauguageUtil.isTrkin()){
                        float dx = mActualTextBounds.left - mUnitBounds.right - gapWidth;
