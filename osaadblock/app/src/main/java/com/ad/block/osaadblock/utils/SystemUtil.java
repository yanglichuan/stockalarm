...
public class SystemUtil {
    ...
    public static boolean installedApp(Context ct,String packageName) {
    ...
    public static void setWifiEnabled(Context ct,boolean enable) {
        Context context = ct.getApplicationContext();
        try {
    ...
    public static boolean isWifiEnabled(Context ct) {
        Context context = ct.getApplicationContext();
    ...
    public static boolean hasPermission(Context ct,String permission) {
        Context context = ct.getApplicationContext();
        int result = context.checkCallingOrSelfPermission(permission);
        return (result == PackageManager.PERMISSION_GRANTED);
    }

    public static void lockScreen(Context ct) {
        Context context = ct.getApplicationContext();
    ...
    public static long getMaxMemory(Context ct) {
    ...
    public static void restartApplication(Context ct,Class<?> clazz) {
        Context context = ct.getApplicationContext();
    ...
    public static void killApplication(Context ct,String packageName) {
        try {
            Context context = ct.getApplicationContext();
