...
public class SaveFlowActivity extends BaseActivity implements CircleProgressView.OnProgressChangedListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_saveflow;
    }
...
//        mCircleView.setShowTextWhileSpinning(true); // Show/hide text in spinning mode
    ...
    protected void adjustHeight(boolean bbar){
        ...
        if(bbar){
            ...
            params.height = CommonUtils.getStatusHeight(SaveFlowActivity.this);
    ...
    public static void openActivity(Context context){
        ...
        it.setClass(context, SaveFlowActivity.class);
    ...
    private void setItem1Select(){
        ...
        tv_title.setText(getString(R.string.dayflow));

        float num1 = AdSaveFlowUtils.getDaysaveflowAdNum(mContext);
        float num2 = AdSaveFlowUtils.getMonthsaveflowAdNum(mContext);
        DecimalFormat decimalFormat=new DecimalFormat("0.00");//构造方法的字符格式这里如果小数不足2位,会以0补足.
        String num1str =decimalFormat.format(num1);//format 返回的是字符
        String num2str =decimalFormat.format(num2);//format 返回的是字符

        tv_num1.setText(num1str+"M");
        tv_num2.setText(num2str+"M");

        int degree = AdSaveFlowUtils.getDaysaveDegree(mContext);
        text_desc.setText(String.format(getString(R.string.daytipflow), degree));
    ...
    private void setItem2Select(){
        ...
        tv_title.setText(getString(R.string.monthflow));
        ...
        int degree = AdSaveFlowUtils.getMonthsaveDegree(mContext);
        text_desc.setText(String.format(getString(R.string.monthtipflow), degree));
        mCircleView.setValueAnimated(degree);
    }
